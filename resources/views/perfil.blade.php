                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                ...
                                <?php $user=Auth::user() ?>
                                {{ Form::model(Auth::user(),array('route' => array('user.update', Auth::user()->id), 'method' => 'PUT')) }}
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <div>
                                                        <span id="alertName" data-toggle="popover" data-trigger="hover" data-placement="right" title="" data-content="" data-original-title="">
                                                            ...
                                                            <input type="text" name="Nom" class="form-control" id="Nom" placeholder="Introduzca su nombre" required="" data-validation-required-message="Por favor introduzca su nomnbre." value="{{ Auth::user()->name }}">
                                                        </span>
                                                    </div>
                                                    <br>
                                                    ...
                                                    <div>
                                                        ...
                                                        <span id="alertEmail" data-toggle="popover" data-trigger="hover" data-placement="right" title="" data-content="" data-original-title=""> 
                                                            ...
                                                            <input type="email" name="email" class="form-control" id="txtEmail" placeholder="Introduzca su email" required="" data-validation-required-message="Por favor introduzca su email." value="{{ Auth::user()->email }}">
                                                        </span>
                                                    ...
                                                    <div>
                                                        <span id="alertName" data-toggle="popover" data-trigger="hover" data-placement="right" title="" data-content="" data-original-title="">
                                                            ...
                                                            <input type="text" class="form-control" id="Cuentablizzard" placeholder="Inserte su batlettag" data-validation-required-message="Por favor introduzca su nombre." name="Cuentablizzard" value="{{ Auth::user()->Cuentablizzard }}">
                                                        </span>
                                                    </div>
                                                    <br>
                                                    <div>
                                                        <span id="alertName" data-toggle="popover" data-trigger="hover" data-placement="right" title="" data-content="" data-original-title="">
                                                            ...
                                                            <input type="text" name="Cuentalol" class="form-control" id="Cuentalol" placeholder="Inserte su cuenta de Lol"  data-validation-required-message="Por favor introduzca su nomnbre." value="{{ Auth::user()->Cuentalol }}">
                                                        </span>
                                                    </div>
                                                <br>
                                                    <div>
                                                        <span id="alertName" data-toggle="popover" data-trigger="hover" data-placement="right" title="" data-content="" data-original-title="">
                                                            ...
                                                            <input type="text" name="Cuentanintendo" class="form-control" id="nintendo" placeholder="Inserte su clave amigo"  data-validation-required-message="Por favor introduzca su nomnbre." value="{{ Auth::user()->Cuentanintendo }}">
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
